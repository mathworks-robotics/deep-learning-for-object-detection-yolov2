classdef redBuoyACFDetector < vision.labeler.AutomationAlgorithm

    properties(Constant)
        
        % Name: Give a name for your algorithm.
        Name = 'Red Buoy ACF Detector';
        
        % Description: Provide a one-line description for your algorithm.
        Description = 'Use this algorithm to automatically label Red Buoys for a dataset from RoboSub';
        ...
        UserDirections = {...
            ...
            'a different ScoreThreshold value, the defalut is set to 80.'...
    ...
    properties
     %SelectedLabelName Selected label name
        ...
        %Detector Detector
        %   Pre-trained redBuoy detector, an object of class
        %   acfObjectDetector.
        redBuoyDetector
   ...
   %---------------------------------------------------------------------- 
    ...
    methods
        function initialize(algObj,~)
            ...
            data = load('redBuoyDetector.mat');
            algObj.redBuoyDetector = data.redBuoyDetector;
        end
        ...
        function autoLabels = run(algObj, I)
            ...
            [bboxes, scores] = detect(algObj.redBuoyDetector, I,...
            ...
            if ~isempty(selectedBbox)
                ...
                % by the detector, of type Rectangle having name of
                % the selected label.
